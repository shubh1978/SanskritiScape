...
public class SecurityConfig extends WebSecurityConfigurerAdapter {//by eztending this class we wl override its methds to chnge the default spring secuirty config
    ...
    @Bean
    public com.llt.school.erp.config.JwtAuthenticationEntryPoint jwtAuthenticationEntryPoint() {
        return new com.llt.school.erp.config.JwtAuthenticationEntryPoint(); // Define bean manually if needed
    }
